...
- 色々一部変更×2
- PWA対応！！！！！インストール可能です！
- 「README.md」の利用規約、プライバシー・ポリシーを変更
- 緊急地震速報を受信したら10分経つまでずっと緊急地震速報が繰り返し鳴り続ける問題を修正
- 緊急地震速報が発表されている都道府県数が15以上の時には地方予報区で読み上げ・表示するように仕様追加
- プログラムの組み忘れで緊急地震速報が発表されていなくても欄に出てしまう問題を修正
- 「README.md」のアプデ履歴移動して戻す
## API詳細
### eewr
